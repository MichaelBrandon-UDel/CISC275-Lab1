...
const yourName : String = "MichaelBrandon Arocho";
let yourPronouns : String = "he/him/his";
const yourMajor : String = "Computer Science";
let classification : String = "Senior";
let oneExcite : String = "Being able to learn HTML for web design";
let anyConcerns : String = "My level of competence in the course";
let funFact : String = "I took up fencing (mostly due to Star Wars)";